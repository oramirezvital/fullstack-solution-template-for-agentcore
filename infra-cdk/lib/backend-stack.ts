...
export class BackendStack extends cdk.NestedStack {
  ...
  private createAgentCoreRuntime(config: AppConfig, investmentTable: dynamodb.Table): void {
    ...
    // Store Alpha Vantage API key in Secrets Manager
    // This secret should be updated after deployment with the actual API key
    const alphaVantageApiKeySecret = new secretsmanager.Secret(this, "AlphaVantageApiKey", {
      secretName: `/${config.stack_name_base}/alpha_vantage_api_key`,
      description: "Alpha Vantage API key for financial data access",
